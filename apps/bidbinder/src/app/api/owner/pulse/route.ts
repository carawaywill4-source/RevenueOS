...
function authorized(request: Request) {
  // Accept ANY configured portfolio auth token so the TR digest fetcher can
  // hit the pulse regardless of which shared secret name is set (the digest
  // side tries PORTFOLIO_PULSE_TOKEN → PORTFOLIO_CRON_SECRET → CRON_SECRET).
  const candidates = [
